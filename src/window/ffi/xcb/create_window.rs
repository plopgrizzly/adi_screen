...
extern {
	fn xcb_generate_id(c: VoidPointer) -> u32;
	fn xcb_create_window(c: VoidPointer, depth: u8, wid: u32,
...
pub fn create_window(connection: VoidPointer, root: u32, visual: u32,
	black: u32) -> u32
{
	let window = unsafe {
